...
class MaterialsController {
    static async getMaterials(req, res) {
        try {
            ...
            const materials = db_1.DatabaseHelper.executeQuery(query, params);
            ...
            const countResult = db_1.DatabaseHelper.getOne(countQuery, countParams);
    ...
    static async getMaterialById(req, res) {
        try {
            const { id } = req.params;
            const material = db_1.DatabaseHelper.getOne(`SELECT 
                    id,
                    material_code,
                    material_name,
                    category,
    ...
    static async getCategories(req, res) {
        try {
            const categories = db_1.DatabaseHelper.executeQuery(`SELECT DISTINCT category 
                FROM materials 
