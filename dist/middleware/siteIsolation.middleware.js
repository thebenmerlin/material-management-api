...
exports.validateSiteAccess = exports.getSiteFilter = exports.enforceSiteIsolation = void 0;
const enforceSiteIsolation = (req, res, next) => {
    if (!req.user) {
...
exports.enforceSiteIsolation = enforceSiteIsolation;
...
exports.getSiteFilter = getSiteFilter;
const validateSiteAccess = (req, siteId) => {
    if (!req.user)
        return false;
...
//# sourceMappingURL=siteIsolation.middleware.js.map